...
const options = features.map((feature: any) => {
  // an array with the data we're actually using for each managment region
...
export const RegionSelector = () => {
  ...
  function handleSubRegionSelect(event: any) {
    dispatch({
      type: ACTIVITY_UPDATE_SIGHTING,
      payload: { subRegion: event.target.value },
    });
  }
  ...
  return (
    <>
      <label>
        <span className="formContent">Management Unit: </span>
      </label>
